    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <?php if (isset($_POST)) {
                    print_r($_POST);
                    // echo "<br/>".$last_sid = mysqli_insert_id($query->conn);
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <!-- <select name="a_sid" id="" class="form-control form-control-lg">
                                            <option value="" selected disabled>--Select Course--</option>
                                            <?php
                                            $fire = $query->select("tbl_student");
                                            if (mysqli_num_rows($fire) > 0) {
                                                while ($row = mysqli_fetch_assoc($fire)) { ?>
                                                    <option class="form-control" value="<?= $last_sid ?>"><?= $row['s_fname'] . " " . $row['s_mname'] . " " . $row['s_lname'] ?></option>
                                            <?php }
                                            }
                                            ?>
                                        </select> -->
                                        <input type="text" name="a_sid" value="" class="form-control" id="" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="a_payable_amount" id="a_payable_amount" placeholder="Total Payable Cost for the student">
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="i_amount" id="i_amount" placeholder="Installment Amount">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <!-- <label for="i_date" class="col-sm-3 col-form-label">Installment Date</label> -->
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="i_aid" id="i_aid" value="<?= $last_aid ?>">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-success mr-2" name="submit">Submit</button>
